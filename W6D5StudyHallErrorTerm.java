...
public class W6D5StudyHallErrorTerm {
	 ...
	 * 
	 * @version 1.00	2018-02-16	Initial baseline for error term recognizer 
	 * 
	 */
	...
	private static String executeFSM(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// If the current character is a zero, it transitions to state 8
			...
			case 1: 
				...
				// If the character is a decimal point, it transitions to state 3
				if (currentChar >= '.') {
					state = 3;
				break;
				}
				//If the current character is in range from 0 to 9, it transition to state 1
			...
			case 2: 
				...
				// if the character is in range from 0 to 9, it transitions to state 4
				if (currentChar >= '0' || currentChar >= '9') {
					state = 4;
					break;
				}
				// if the character is plus or minus, it accepts the value and stays in state 2
			...
			case 3:
				...
				//if the character is in range from 1 to 9, it transitions to state 4
				if (currentChar >= '1' || currentChar >= '9') {
					state = 4;
					break;
				}
				//if the character is zero, it transitions to state 9
				else if (currentChar == '0') {
					state = 9;
					break;
				}
			...
			case 4: 
				...
				//if the character is in the range from 0 to 9, it accepts the character and
				//stays in the state 4
				if (currentChar >= '0' || currentChar >= '9') {
					break;
				}
			...
			case 9: 
				...
				//if the character is plus or minus, it transitions to state 5
				else if (currentChar == '+' || currentChar == '-') {
					state = 5;
					break;
				}
		...
		case 1:
			// This is a stub that must be filled in
			// State 1 is not a final state. In order to move forward, the next character must be 
			// a digit or decimal point
			return "This character must be a digit or decimal point";

		case 2:
			// This is a stub that must be filled in
			// State 2 is not a final state. In order to move forward, the next character must be 
			// a digit or a plus or a minus.
			return "This charcter must be a digit or a plus or a minus";

		case 3:
			// This is a stub that must be filled in
			// State 3 is not a final state. so in order to move forward, the next character must be
			// a digit.
			return "This character must be a digit ";

		case 4:
			// This is a stub that must be filled in
			// State 4 is similar to state 7, it is a final state, so it must be processed differently.
			// If the next character is not a digit, the FSM stops with an error.
			// We must see here if there are no more characters. If there are no characters, we accept the input,
